...
tls_clientSocket.send(base64.b64encode(bytes('gmailAccount','utf-8')))
...
mailFromCommand = 'MAIL From: <xxxxxxxxxxx@gmail.com>\r\n'
...
rcptToCommand = "RCPT TO: <xxxxxxxxx@gmail.com>\r\n"
